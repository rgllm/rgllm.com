...
2. Fazer download do [Firefox 90.0](https://ftp.mozilla.org/pub/firefox/releases/90.0/mac/en-US/) já que não funciona nas versões mais recentes e instalar.
...
7. Ao entrar no [automovelonline.mj.pt](https://www.automovelonline.mj.pt/) aparece um aviso com os dados e certificados para aceitar.

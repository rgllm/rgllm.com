      ...
      <div className="flex flex-col w-full max-w-2xl mx-auto mt-0 mb-8">
        ...
        <div className="relative w-full">
          <input
            ...
            className="block w-full px-4 py-2 text-gray-900 bg-white border border-gray-200 rounded-md focus:ring-blue-500 focus:border-blue-500 umami--input--bookmarkssearch"
          />
          <svg

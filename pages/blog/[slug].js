...
import { Heading, Text, Flex, Stack, Image } from '@chakra-ui/react'
	...
	return (
		<Container>
			...
			<Stack
				...
				<Image objectFit="cover" src={post.image} alt={post.title} />
...
export async function getStaticProps({ params }) {
	const post = getPostBySlug(params.slug, ['title', 'date', 'slug', 'content', 'image'])

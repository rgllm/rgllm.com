...
import { Flex, Heading, Icon, Input, InputGroup, InputRightElement, Stack, Text, useColorMode } from '@chakra-ui/react'
...
const description = 'Thoughts on the software engineering, programming, tech, and my personal life.'
				...
				<Stack
					...
					<Flex flexDirection="column" justifyContent="flex-start" alignItems="flex-start" maxWidth="700px">
						<Heading
							...
							as="h1"
							size="2xl"
							color={colorMode === 'light' ? '#171923' : 'white'}>
							All Posts
						</Heading>

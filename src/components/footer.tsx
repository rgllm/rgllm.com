...
export function Footer() {
	return (
		<footer className="text-xs text-gray-500 dark:text-white font-mono border-t border-gray-200 dark:border-gray-800 pt-4 mt-6 sm:mt-8">
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
				<div className="hover:opacity-70 transition-opacity duration-500 cursor-default">
					© 2025 rgllm.com • built with curiosity
				</div>
